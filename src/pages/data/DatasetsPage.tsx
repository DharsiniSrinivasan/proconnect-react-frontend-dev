  ...
  import { DownloadReport } from "@/services/dataSetServices";
          ...
          <div className="flex items-center gap-3">
            {hasPermission("manage-excel-templates") && (
              <>
                <Button
                  variant="outline"
                  className="border-border/50 text-muted-foreground hover:text-foreground hover:bg-muted/20"
                ...
                <Button
                  onClick={() => navigate("/data/new-upload")}
